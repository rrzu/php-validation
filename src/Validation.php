...
use Closure;
use RRZU\Validation\Rules\Interfaces\BeforeValidate;
use RRZU\Validation\Rules\Interfaces\ModifyValue;
use RRZU\Validation\Rules\Required;
...
class Validation
{
     ...
     * Constructor
     *
     * @param \RRZU\Validation\Validator $validator
     * @param array $inputs
     * @param array $rules
     ...
     *
     * @param string $attributeKey
     * @return null|\RRZU\Validation\Attribute
     */
     ...
     *
     * @return \RRZU\Validation\ErrorBag
     */
     ...
     * Validate attribute
     *
     * @param \RRZU\Validation\Attribute $attribute
     * @return void
     */
...
//        }
     ...
     * @param \RRZU\Validation\Attribute $attribute
     * @param mixed $value
     * @param \RRZU\Validation\Rule $ruleValidator
     * @return void
     */
     ...
     *
     * @param \RRZU\Validation\Attribute $attribute
     * @param \RRZU\Validation\Rule $rule
     * @return bool
     */
     ...
     * @param \RRZU\Validation\Attribute $attribute
     * @param mixed $value
     * @param \RRZU\Validation\Rule $validator
     * @return mixed
     */
     ...
     *
     * @return \RRZU\Validation\Validator
     */
