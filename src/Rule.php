...
use RRZU\Validation\MissingRequiredParameterException;
...
abstract class Rule
{
    ...
    /** @var \RRZU\Validation\Attribute|null */
    protected $attribute;

    /** @var \RRZU\Validation\Validation|null */
     ...
     *
     * @param \RRZU\Validation\Validation $validation
     * @return void
     */
     ...
     * Get attribute
     *
     * @return \RRZU\Validation\Attribute|null
     */
     ...
     * @param array $params
     * @return void
     * @throws \RRZU\Validation\MissingRequiredParameterException
     */
